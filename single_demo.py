...
parser.add_argument('--image_path', default=data_dir +class_+'Images/', type=str, help="image path")
parser.add_argument('--label_path', default=data_dir +class_+ 'GroundTruth/', type=str, help="label1")
...
parser.add_argument('--model', default='/home/gongxp/mlmr/githubcode/'
        'Semantic-Aware-Attention-Based-Deep-Object-Co-segmentation/model_path/model_512_epoch48loss0.5079iou0.7467.ckpt',
